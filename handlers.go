...
func (fe *frontendServer) homeHandler(w http.ResponseWriter, r *http.Request) {
	...
	var envNamespace = os.Getenv("ENV_NAMESPACE")
	plat = platformDetails{}
	plat.setPlatformDetails(strings.ToLower(env), strings.ToLower(envNamespace))
...
func (plat *platformDetails) setPlatformDetails(env string, envNamespace string) {
	if env == "aws" {
		plat.provider = "AWS"
		plat.css = "aws-platform"
	} else if env == "onprem" {
		if envNamespace == "boutique-production" {
			plat.provider = "On-Premises"
			plat.css = "onprem-platform"
		} else if envNamespace == "boutique-canary" {
			plat.provider = "On-Premises canary"
			plat.css = "onprem-note-platform"
		} else {
			plat.provider = "On-Premises staging"
			plat.css = "onprem-note-platform"
		}
	} else if env == "azure" {
		plat.provider = "Azure"
